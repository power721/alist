...
type Addition struct {
	...
	ShareCode   string  `json:"share_id" type:"text" required:"true" help:"share code of 115 share link"`
	ReceiveCode string  `json:"share_pwd" type:"text" required:"true" help:"receive code of 115 share link"`
	driver.RootID
}
